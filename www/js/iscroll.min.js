...
this.x+c/2:0<=e||0<=this.maxScrollX?0:this.maxScrollX;if(g>this.minScrollY||g<this.maxScrollY)g=this.options.bounce?this.y+d/2:g>=this.minScrollY||0<=this.maxScrollY?this.minScrollY:this.maxScrollY;this.distX+=c;this.distY+=d;this.absDistX=f.abs(this.distX);this.absDistY=f.abs(this.distY);if(!(this.absDistX<this.options.hThreshold&&this.absDistY<this.options.vThreshold)){if(this.absDistY>this.absDistX){if(!this.options.vScroll)return}else if(!this.options.hScroll)return;this.options.lockDirection&&
(this.absDistX>this.absDistY+(this.options.vThreshold-1)?(g=this.y,d=0):this.absDistY>this.absDistX+(this.options.hThreshold-1)&&(e=this.x,c=0));this.moved=!0;this._pos(e,g);this.dirX=0<c?-1:0>c?1:0;this.dirY=0<d?-1:0>d?1:0;300<h-this.startTime&&(this.startTime=h,this.startX=this.x,this.startY=this.y);this.options.onScrollMove&&this.options.onScrollMove.call(this,b)}}},_end:function(b){if(!(m&&0!==b.touches.length)){var a=this,c=m?b.changedTouches[0]:b,d,e,g={dist:0,time:0},k={dist:0,time:0},v=(b.timeStamp||
Date.now())-a.startTime,l=a.x,j=a.y;a._unbind(y,h);a._unbind(z,h);a._unbind(A,h);a.options.onBeforeScrollEnd&&a.options.onBeforeScrollEnd.call(a,b);if(a.zoomed)l=a.scale*a.lastScale,l=Math.max(a.options.zoomMin,l),l=Math.min(a.options.zoomMax,l),a.lastScale=l/a.scale,a.scale=l,a.x=a.originX-a.originX*a.lastScale+a.x,a.y=a.originY-a.originY*a.lastScale+a.y,a.scroller.style[t]="200ms",a.scroller.style[q]="translate("+a.x+"px,"+a.y+"px) scale("+a.scale+")"+s,a.zoomed=!1,a.refresh(),a.options.onZoomEnd&&
a.options.onZoomEnd.call(a,b);else{if(a.moved){if(300>v&&a.options.momentum){g=l?a._momentum(l-a.startX,v,-a.x,a.scrollerW-a.wrapperW+a.x,a.options.bounce?a.wrapperW:0):g;k=j?a._momentum(j-a.startY,v,-a.y,0>a.maxScrollY?a.scrollerH-a.wrapperH+a.y-a.minScrollY:0,a.options.bounce?a.wrapperH:0):k;l=a.x+g.dist;j=a.y+k.dist;if(0<a.x&&0<l||a.x<a.maxScrollX&&l<a.maxScrollX)g={dist:0,time:0};if(a.y>a.minScrollY&&j>a.minScrollY||a.y<a.maxScrollY&&j<a.maxScrollY)k={dist:0,time:0}}g.dist||k.dist?(g=f.max(f.max(g.time,
k.time),10),a.options.snap&&(k=l-a.absStartX,v=j-a.absStartY,f.abs(k)<a.options.snapThreshold&&f.abs(v)<a.options.snapThreshold?a.scrollTo(a.absStartX,a.absStartY,200):(k=a._snap(l,j),l=k.x,j=k.y,g=f.max(k.time,g))),a.scrollTo(f.round(l),f.round(j),g)):a.options.snap?(k=l-a.absStartX,v=j-a.absStartY,f.abs(k)<a.options.snapThreshold&&f.abs(v)<a.options.snapThreshold?a.scrollTo(a.absStartX,a.absStartY,200):(k=a._snap(a.x,a.y),(k.x!=a.x||k.y!=a.y)&&a.scrollTo(k.x,k.y,k.time))):a._resetPos(200)}else m&&
(a.doubleTapTimer&&a.options.zoom?(clearTimeout(a.doubleTapTimer),a.doubleTapTimer=null,a.options.onZoomStart&&a.options.onZoomStart.call(a,b),a.zoom(a.pointX,a.pointY,1==a.scale?a.options.doubleTapZoom:1),a.options.onZoomEnd&&setTimeout(function(){a.options.onZoomEnd.call(a,b)},200)):this.options.handleClick&&(a.doubleTapTimer=setTimeout(function(){a.doubleTapTimer=null;for(d=c.target;1!=d.nodeType;)d=d.parentNode;"SELECT"!=d.tagName&&("INPUT"!=d.tagName&&"TEXTAREA"!=d.tagName)&&(e=w.createEvent("MouseEvents"),
e.initMouseEvent("click",!0,!0,b.view,1,c.screenX,c.screenY,c.clientX,c.clientY,b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,0,null),e._fake=!0,d.dispatchEvent(e))},a.options.zoom?250:0))),a._resetPos(400);a.options.onTouchEnd&&a.options.onTouchEnd.call(a,b)}}},_resetPos:function(b){var a=0<=this.x?0:this.x<this.maxScrollX?this.maxScrollX:this.x,c=this.y>=this.minScrollY||0<this.maxScrollY?this.minScrollY:this.y<this.maxScrollY?this.maxScrollY:this.y;a==this.x&&c==this.y?(this.moved&&(this.moved=!1,this.options.onScrollEnd&&
this.options.onScrollEnd.call(this)),this.hScrollbar&&this.options.hideScrollbar&&("webkit"==n&&(this.hScrollbarWrapper.style[C]="300ms"),this.hScrollbarWrapper.style.opacity="0"),this.vScrollbar&&this.options.hideScrollbar&&("webkit"==n&&(this.vScrollbarWrapper.style[C]="300ms"),this.vScrollbarWrapper.style.opacity="0")):this.scrollTo(a,c,b||0)},_wheel:function(b){var a=this,c,d;if("wheelDeltaX"in b)c=b.wheelDeltaX/12,d=b.wheelDeltaY/12;else if("wheelDelta"in b)c=d=b.wheelDelta/12;else if("detail"in
b)c=d=3*-b.detail;else return;"zoom"==a.options.wheelAction?(d=a.scale*Math.pow(2,1/3*(d?d/Math.abs(d):0)),d<a.options.zoomMin&&(d=a.options.zoomMin),d>a.options.zoomMax&&(d=a.options.zoomMax),d!=a.scale&&(!a.wheelZoomCount&&a.options.onZoomStart&&a.options.onZoomStart.call(a,b),a.wheelZoomCount++,a.zoom(b.pageX,b.pageY,d,400),setTimeout(function(){a.wheelZoomCount--;!a.wheelZoomCount&&a.options.onZoomEnd&&a.options.onZoomEnd.call(a,b)},400))):(c=a.x+c,d=a.y+d,0<c?c=0:c<a.maxScrollX&&(c=a.maxScrollX),
d>a.minScrollY?d=a.minScrollY:d<a.maxScrollY&&(d=a.maxScrollY),0>a.maxScrollY&&a.scrollTo(c,d,0))},_transitionEnd:function(b){b.target==this.scroller&&(this._unbind(u),this._startAni())},_startAni:function(){var b=this,a=b.x,c=b.y,d=Date.now(),e,g,h;b.animating||(b.steps.length?(e=b.steps.shift(),e.x==a&&e.y==c&&(e.time=0),b.animating=!0,b.moved=!0,b.options.useTransition?(b._transitionTime(e.time),b._pos(e.x,e.y),b.animating=!1,e.time?b._bind(u):b._resetPos(0)):(h=function(){var j=Date.now(),l;j>=
d+e.time?(b._pos(e.x,e.y),b.animating=!1,b.options.onAnimationEnd&&b.options.onAnimationEnd.call(b),b._startAni()):(j=(j-d)/e.time-1,g=f.sqrt(1-j*j),j=(e.x-a)*g+a,l=(e.y-c)*g+c,b._pos(j,l),b.animating&&(b.aniTime=Q(h)))},h())):b._resetPos(400))},_transitionTime:function(b){b+="ms";this.scroller.style[t]=b;this.hScrollbar&&(this.hScrollbarIndicator.style[t]=b);this.vScrollbar&&(this.vScrollbarIndicator.style[t]=b)},_momentum:function(b,a,c,d,e){a=f.abs(b)/a;var g=a*a/0.0012;0<b&&g>c?(c+=e/(6/(6E-4*
(g/a))),a=a*c/g,g=c):0>b&&g>d&&(d+=e/(6/(6E-4*(g/a))),a=a*d/g,g=d);return{dist:g*(0>b?-1:1),time:f.round(a/6E-4)}},_offset:function(b){for(var a=-b.offsetLeft,c=-b.offsetTop;b=b.offsetParent;)a-=b.offsetLeft,c-=b.offsetTop;b!=this.wrapper&&(a*=this.scale,c*=this.scale);return{left:a,top:c}},_snap:function(b,a){var c,d,e;e=this.pagesX.length-1;c=0;for(d=this.pagesX.length;c<d;c++)if(b>=this.pagesX[c]){e=c;break}e==this.currPageX&&(0<e&&0>this.dirX)&&e--;b=this.pagesX[e];d=(d=f.abs(b-this.pagesX[this.currPageX]))?
500*(f.abs(this.x-b)/d):0;this.currPageX=e;e=this.pagesY.length-1;for(c=0;c<e;c++)if(a>=this.pagesY[c]){e=c;break}e==this.currPageY&&(0<e&&0>this.dirY)&&e--;a=this.pagesY[e];c=(c=f.abs(a-this.pagesY[this.currPageY]))?500*(f.abs(this.y-a)/c):0;this.currPageY=e;e=f.round(f.max(d,c))||200;return{x:b,y:a,time:e}},_bind:function(b,a,c){(a||this.scroller).addEventListener(b,this,!!c)},_unbind:function(b,a,c){(a||this.scroller).removeEventListener(b,this,!!c)},destroy:function(){this.scroller.style[q]="";
