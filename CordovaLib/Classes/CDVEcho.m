...
{
    [self.commandDelegate sendPluginResult:args[0] callbackId:args[1]];
}
...
- (void)echoAsync:(CDVInvokedUrlCommand*)command
{
    ...
    [self performSelector:@selector(echoAsyncHelper:) withObject:@[pluginResult, command.callbackId] afterDelay:0];
}
